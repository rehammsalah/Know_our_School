  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Consumer<ShowData>(
          builder: (context,showdata, child) => Column(
            ...
            children: [
              ...
              reusableTextField(showdata!.model == null ? schoolName :showdata!.model!.SchoolName!, Icons.school),
              const SizedBox(height: 15,),
              reusableTextField(showdata!.model == null ? schoolAddress :showdata!.model!.SchoolAddress!, Icons.location_on_rounded),
              const SizedBox(height: 15,),
              reusableTextField(showdata!.model == null ? studentsNo :showdata!.model!.NumberOfStudents!, Icons.person),
              const SizedBox(height: 15,),
              reusableTextField(showdata!.model == null ? teachersNo :showdata!.model!.NumberOfTeachers!, Icons.person),
              Padding(
